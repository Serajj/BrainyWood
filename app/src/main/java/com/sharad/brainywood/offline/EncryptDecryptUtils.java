...
import static com.sharad.brainywood.offline.Constants.CIPHER_ALGORITHM;
import static com.sharad.brainywood.offline.Constants.KEY_SPEC_ALGORITHM;
import static com.sharad.brainywood.offline.Constants.OUTPUT_KEY_LENGTH;
import static com.sharad.brainywood.offline.Constants.PROVIDER;
...
public class EncryptDecryptUtils {
    ...
    public static byte[] encode(SecretKey yourKey, byte[] fileData)
        ...
        prefUtils.encStatus(true);
        prefUtils.dcrptstatus(false);
    ...
    public static byte[] decode(SecretKey yourKey, byte[] fileData)
        ...
        prefUtils.encStatus(false);
        prefUtils.dcrptstatus(true);
        return decrypted;
    }
    ...
    public boolean getEncStatus(){
        return prefUtils.getEnc();
    }

    public boolean getDecStatus(){
        return prefUtils.getDcryStatus();
    }
